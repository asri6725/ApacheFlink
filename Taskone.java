...
public static <R> void main(String[] args) throws Exception {
    ...
    DataSet<Tuple1< String>> result = joinresult.flatMap(new concats()); // Concatenates Cessna with model no and reduces model no to 3 digits  
  ...
  @SuppressWarnings("serial")
  private static class concats implements FlatMapFunction<Tuple3<String, String, Integer>, Tuple1<String>>{
	  public void flatMap( Tuple3<String, String, Integer> input_tuple, Collector<Tuple1<String>> output) {
		  ...
		  model = model+"\t"+input_tuple.f2.toString();
		  output.collect(new Tuple1<String> (model));
	  }
  }
