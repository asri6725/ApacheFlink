...
public static <R> void main(String[] args) throws Exception {
    ...
    String output_filepath = "C:/Users/Abhi/Desktop/Task1optres.csv"; //result output location
    ...
    DataSet<Tuple4<String, String,String,Integer>> joinresult =
    		flights.join(aircrafts).where(0).equalTo(0) //join flights with tail number so we get all the flights
    		.projectSecond(0,1,2,3); //only copy manufacturer, model no and 1
    
    DataSet<Tuple4<String, String, String, Integer>> cessnaaircraft = 
    		joinresult.filter(new FilterFunction<Tuple4<String,String, String, Integer>>(){
	...
	DataSet<Tuple4<String, String, String, Integer>> cessnacount = cessnaaircraft.flatMap(new cesMappera()); //Change CESSNA to Cessna and change year to 1 
	
    DataSet<Tuple2< String,Integer>> result = cessnacount.flatMap(new concatss()); // Concatenates Cessna with model no and reduces model no to 3 digits  
    ...
    .writeAsCsv(output_filepath,WriteMode.OVERWRITE);
    // execute the FLink job
    env.execute("Executing task 1 unopt");
  ...
  @SuppressWarnings("serial")
  private static class cesMappera implements FlatMapFunction<Tuple4<String, String, String, Integer>, Tuple4<String, String, String, Integer>> {
  ...
  @SuppressWarnings("serial")
  private static class concatss implements FlatMapFunction<Tuple4<String, String, String, Integer>, Tuple2<String, Integer>>{
	  public void flatMap( Tuple4<String, String, String, Integer> input_tuple, Collector<Tuple2<String, Integer>> output) {
		  ...
		  output.collect(new Tuple2<String,Integer> (model, input_tuple.f3));
	  }
  }
